...
@endforeach
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      @foreach($sessions as $session)<td class="currency"><b>{!! $figures->collected[$session->id]->remittance->count !!}</b></td>@endforeach
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      @foreach($sessions as $session)<td class="currency"><b>{!! $figures->collected[$session->id]->remittance->amount !!}</b></td>@endforeach
                    </tr>
                    <tr>
