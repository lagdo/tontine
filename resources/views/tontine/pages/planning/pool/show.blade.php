      <div class="portlet-body form">
        <form class="form-horizontal" role="form" id="campaign-form">
          <div class="module-body">
            ...
            <div class="form-group row">
              {!! Form::label('start_at', __('common.labels.dates'), ['class' => 'col-sm-3 col-form-label text-right']) !!}
              <div class="col-sm-4">
            ...
            <div class="form-group row">
              {!! Form::label('numbers', __('common.labels.numbers'), ['class' => 'col-sm-3 col-form-label text-right']) !!}
              <div class="col-sm-9">
...
@foreach ($locales as $locale => $properties)
              <div class="tab-pane @if ($loop->first)active @endif" id="locale_{{ $locale }}">
                <div class="form-group row">
                  {!! Form::label('label', __('common.labels.title'), ['class' => 'col-sm-3 col-form-label text-right']) !!}
                  <div class="col-sm-8">
                    {!! Form::text('label', $campaign->translate($locale)->label, ['class' => 'form-control', 'readonly' => 'readonly']) !!}
                  </div>
                </div>
                <div class="form-group row">
                  {!! Form::label('description', __('common.labels.description'), ['class' => 'col-sm-3 col-form-label text-right']) !!}
                  <div class="col-sm-9">
