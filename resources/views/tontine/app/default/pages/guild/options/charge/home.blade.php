@php
  $rqCharge = rq(Ajax\App\Guild\Options\Charge::class);
  $rqChargeFunc = rq(Ajax\App\Guild\Options\ChargeFunc::class);
  $rqChargePage = rq(Ajax\App\Guild\Options\ChargePage::class);
@endphp
