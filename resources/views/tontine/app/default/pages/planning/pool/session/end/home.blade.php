@php
  ...
  $rqEndSessionTitle = rq(Ajax\App\Planning\Pool\Session\Pool\EndSessionTitle::class);
  $rqEndSessionAction = rq(Ajax\App\Planning\Pool\Session\Pool\EndSessionAction::class);
