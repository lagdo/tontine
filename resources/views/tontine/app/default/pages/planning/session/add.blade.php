      <div class="portlet-body form">
        <form class="form-horizontal" role="form" id="session-form">
          <div class="module-body">
            ...
            <div class="form-group row">
              {!! Form::label('host_id', __('tontine.session.labels.host'), ['class' => 'col-sm-3 col-form-label']) !!}
              <div class="col-md-8">
                {!! Form::select('host_id', $members, 0, ['class' => 'form-control']) !!}
              </div>
            </div>
            <div class="form-group row">
              {!! Form::label('date', __('common.labels.date'), ['class' => 'col-sm-3 col-form-label']) !!}*
              <div class="col-sm-6">
                {!! Form::date('date', '', ['class' => 'form-control']) !!}
              </div>
            </div>
            <div class="form-group row">
              {!! Form::label('start', __('tontine.session.labels.times'), ['class' => 'col-sm-3 col-form-label']) !!}
              <div class="col-sm-4">
