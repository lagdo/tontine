      <div class="portlet-body form">
        <form class="form-horizontal" role="form" id="tontine-form">
          <div class="module-body">
            ...
            <div class="form-group row">
              {!! Form::label('shortname', __('common.labels.shortname'), ['class' => 'col-sm-3 col-form-label']) !!}
              <div class="col-sm-7">
            ...
            <div class="form-group row">
              {!! Form::label('country_code', __('common.labels.country'), ['class' => 'col-sm-3 col-form-label']) !!}
              <div class="col-sm-9">
                {!! Form::select('country_code', $countries, $tontine->country_code, ['class' => 'form-control', 'id' => 'select_country_dropdown']) !!}
              </div>
            </div>
            <div class="form-group row">
              {!! Form::label('currency_code', __('common.labels.currency'), ['class' => 'col-sm-3 col-form-label']) !!}
