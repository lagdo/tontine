        ...
        <form class="form-horizontal" role="form" id="tontine-form">
          <div class="module-body">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                {!! $html->text('name', $tontine->name)->class('form-control') !!}
              </div>
            </div>
            <div class="form-group row">
              {!! $html->label(__('common.labels.shortname'), 'shortname')->class('col-sm-3 col-form-label') !!}
              <div class="col-sm-7">
                {!! $html->text('shortname', $tontine->shortname)->class('form-control') !!}
              </div>
            </div>
            <div class="form-group row">
              {!! $html->label(__('common.labels.city'), 'city')->class('col-sm-3 col-form-label') !!}
              <div class="col-sm-7">
                {!! $html->text('city', $tontine->city)->class('form-control') !!}
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-9" @jxnOn(['select', 'change'], $rqLocaleFunc->selectCurrency(jq()->val()))>
                {!! $html->select('country_code', $countries, $tontine->country_code)->class('form-control') !!}
              </div>
            </div>
            <div class="form-group row">
