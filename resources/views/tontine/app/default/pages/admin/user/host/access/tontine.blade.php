                          ...
                          <div class="module-body">
                            <div class="form-group row">
                              ...
                              <div class="col-md-11 offset-md-1">
                                {!! $html->checkbox('access[tontine][members]', $access['tontine']['members'] ?? false, '1') !!}
                                {!! $html->label(__('tontine.menus.members'), '')->class('form-check-label') !!}
                              </div>
                              <div class="col-md-11 offset-md-1">
                                {!! $html->checkbox('access[tontine][categories]', $access['tontine']['categories'] ?? false, '1') !!}
                                {!! $html->label(__('tontine.menus.categories'), '')->class('form-check-label') !!}
                              </div>
                              <div class="col-md-11 offset-md-1">
                                {!! $html->checkbox('access[tontine][calendar]', $access['tontine']['calendar'] ?? false, '1') !!}
