        ...
        <form class="form-horizontal" role="form" id="refund-form">
          <div class="module-body">
            <div class="form-group row">
              {!! $html->label(__('meeting.labels.debt'), 'debt')->class('col-sm-2 col-form-label') !!}
              <div class="col-sm-10">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-5">
                {!! $html->text('amount', $refundAmount)->class('form-control') !!}
              </div>
              <div class="col-sm-4">
                {!! $html->label("Max: $payableAmount", '')->class('col-form-label') !!}
              </div>
            </div>
          </div>
        </form>
