      ...
      <div class="portlet-body form">
        <form class="form-horizontal" role="form" id="loan-form">
          <div class="module-body">
            ...
            <div class="form-group row">
              {!! Form::label('principal', __('meeting.loan.labels.principal'), ['class' => 'col-sm-3 col-form-label']) !!}
              <div class="col-sm-5">
                {!! Form::text('principal', $locale->getMoneyValue($loan->principal), ['class' => 'form-control']) !!}
              </div>
            </div>
            <div class="form-group row">
              {!! Form::label('fund', __('meeting.loan.labels.fund'), ['class' => 'col-sm-3 col-form-label']) !!}
              <div class="col-sm-8">
                {!! Form::select('fund', $funds, $loan->fund_id, ['class' => 'form-control']) !!}
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              {!! Form::label('interest_type', __('common.labels.type'), ['class' => 'col-sm-3 col-form-label']) !!}
              <div class="col-sm-7">
            ...
            <div class="form-group row">
              {!! Form::label('interest', $loan->fixed_interest ? __('common.labels.amount') : __('meeting.loan.labels.percentage'),
                ['class' => 'col-sm-3 col-form-label', 'id' => 'loan-interest-label']) !!}
              <div class="col-sm-5">
