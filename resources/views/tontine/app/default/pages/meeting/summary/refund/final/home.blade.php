@php
  ...
  $rqTotalRefundFunc = rq(Ajax\App\Meeting\Summary\Credit\Total\RefundFunc::class);
...
@if($funds->count() > 1)
                        <div class="input-group mb-2">
                          ...
                          <div class="input-group-append">
                            <button type="button" class="btn btn-primary" @jxnClick($rqTotalRefund->fund($fundId))><i class="fa fa-arrow-right"></i></button>
