        ...
        <form class="form-horizontal" role="form" id="target-form">
          <div class="module-body">
            <div class="form-group row">
              ...
              <div class="col-sm-7">
                {!! $htmlBuilder->text('amount', $locale->getMoneyValue($target->amount))->class('form-control') !!}
              </div>
            </div>
            <div class="form-group row">
              <div class="offset-md-3 col-md-8">
                {!! $htmlBuilder->checkbox('global', $target->global, '1') !!}
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                {!! $htmlBuilder->select('deadline', $sessions, $target->deadline_id)->class('form-control') !!}
              </div>
            </div>
          </div>
        </form>
