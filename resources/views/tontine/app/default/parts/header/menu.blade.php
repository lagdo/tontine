...
@if (!isset($hideSidebar) || !$hideSidebar)
          <ul class="navbar-nav mr-3">
            <li><a role="link" data-toggle="sidebar" class="nav-link nav-link-lg"><i class="fa fa-bars"></i></a></li>
          </ul>
@endif
          <ul class="navbar-nav">
            <li class="dropdown language">
              <a role="link" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
