...
@if($receivables->count() > 0)
              <div class="card shadow mb-4">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      @include('tontine_app::pages.meeting.payment.deposits', ['receivables' => $receivables])
                    </div>
                  </div>
                </div>
              </div>
...
@if($debts->count() > 0)
              <div class="card shadow mb-4">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      @include('tontine_app::pages.meeting.payment.debts', ['debts' => $debts])
                    </div>
                  </div>
                </div>
              </div>
...
@if($bills->count() > 0)
              <div class="card shadow mb-4">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-12">
                      @include('tontine_app::pages.meeting.payment.bills', ['bills' => $bills])
                    </div>
                  </div>
                </div>
              </div>
