...
@php
$email = old('email', 'admin@company.com');
$password = config('tontine.app.demo', false) &&
    $email === 'admin@company.com' ? 'password' : '';
@endphp
                    <input id="email" type="email" class="form-control @error('email')is-invalid @enderror" name="email" value="{{ $email }}" tabindex="1" required autofocus>
