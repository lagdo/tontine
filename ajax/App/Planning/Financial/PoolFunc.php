...
class PoolFunc extends FuncComponent
{
    ...
    public function showIntro()
    {
        ...
        $content = $this->renderView('pages.planning.financial.pool.add_intro', [
    ...
    public function showDepositFixed()
    {
        ...
        $content = $this->renderView('pages.planning.financial.pool.deposit_fixed', [
    ...
    public function showDepositLendable()
    {
        ...
        $properties = $this->bag('pool')->get('add', []);
        $title = trans('tontine.pool.titles.deposits');
        $content = $this->renderView('pages.planning.financial.pool.deposit_lendable', [
    ...
    public function showRemitPlanned()
    {
        ...
        $content = $this->renderView('pages.planning.financial.pool.remit_planned', [
    ...
    public function showRemitAuction()
    {
        ...
        $title = trans('tontine.pool.titles.remitments');
        $content = $this->renderView('pages.planning.financial.pool.remit_auction', [
    ...
    public function add()
    {
        ...
        $title = trans('tontine.pool.titles.add');
        $content = $this->renderView('pages.planning.financial.pool.add', [
            'properties' => $this->bag('pool')->get('add', []),
        ]);
        $buttons = [[
            'title' => trans('common.actions.cancel'),
    ...
    public function edit(int $poolId)
    {
        ...
        $content = $this->renderView('pages.planning.financial.pool.edit', [
            'pool' => $pool,
