...
class ChargeFunc extends FuncComponent
{
    ...
    {
        $title = '';
        $content = $this->renderView('pages.guild.options.charge.select', [
    ...
    public function add(int $group)
    {
        ...
        $content = $this->renderView('pages.guild.options.charge.add', [
    ...
    public function edit(int $chargeId)
    {
        ...
        $content = $this->renderView('pages.guild.options.charge.edit', [
            'charge' => $charge,
            'currency' => $currency,
